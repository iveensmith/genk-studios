...
const caseStudies = [
  ...
  },
  {
    ...
    problem:
      'Teams ship AI voice agents and only find the failures when a customer does. VoiceIQ had to test an agent the way a customer would — a real phone call — and prove whether it actually did what it said it would.',
    approach: [
